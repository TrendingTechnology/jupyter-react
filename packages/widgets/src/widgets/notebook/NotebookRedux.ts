    ...
    action$
      .pipe(
        ofAction(
          ...
          notebookActions.kernelStatusChanged.started,
          notebookActions.run.started,
          notebookActions.runAll.started,
          notebookActions.interrupt.started,
          notebookActions.delete.started,
          notebookActions.insertAbove.started,
          notebookActions.insertBelow.started,
          notebookActions.portal.started,
        ),
...
//      portals: new Array<React.ReactPortal>()
  ...
  .case(notebookActions.portal.done, (state: INotebookState, success: Success<React.ReactPortal, React.ReactPortal>) => {
    return {
      ...state,
      portals: state.portals.concat([success.result])
    }
  });
